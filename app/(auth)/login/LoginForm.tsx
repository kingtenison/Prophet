      ...
      >
        ...
        <div className="mt-6">
          ...
          <div className="mt-5 grid grid-cols-2 gap-3">
            <button
              type="button"
              className="flex items-center justify-center gap-2 px-4 py-2.5 border border-secondary-200 rounded-xl hover:bg-secondary-50 transition-colors font-medium text-sm text-secondary-700"
            >
